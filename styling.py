...
# PAGE SETTINGS
# ----------------------------------------------------------------------------
app_title = 'Maryland Environmental Education Directory'
page_title = 'Maryland Environmental Education Directory'
sub_title = 'Filter on'
...
# MAP SETTINGS
# ----------------------------------------------------------------------------
map_center_lat = 38.797406
map_center_lon = -78.5559902
map_zoom = 6.372
