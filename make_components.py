...
def make_map(orgdata, lat_col, lon_col, choro_geojson,  featureidkey, statehover, choro_df, choro_df_location, choro_df_value, map_center_lat, map_center_lon, map_zoom = 5, hover_name = "Organization", hover_data = None):
    # Design point layer
